    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div>
          ...
          <form class="w-full" action="{{ route('admin.items.store') }}" method="post" encitems="multipart/form-data">
            @csrf
                ...
                <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                  <div class="w-full">
                    ...
                    <input value="{{ old('photos') }}" name="photos[]" 
                           class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                           id="grid-last-name" accept="image/png, image/jpeg, image/jpg, image/webp" type="file" multiple required>
                    <div class="mt-2 text-sm text-gray-500">
                        Masukan Foto Item  
                    </div>
                  </div>
